...
$client->setRedirectUri(WEBSITE_URL.'/google-login');
...
if (isset($_GET['code'])) {
    ...
    if ($access_token) {
        ...
        $profilePicUrl = $userInfo->getPicture();
...
// if($data['image_url'] != $profilePicUrl){
// $sql234 = $conn->query("UPDATE user_data SET image_url='".$profilePicUrl."' WHERE id='".$data['id']."'");
// }
