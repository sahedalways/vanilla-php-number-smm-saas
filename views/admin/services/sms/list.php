...
<head>
    ...
    <title>SMS Services | Admin</title>
...
<body>
    ...
    <script>
        function fetchFilteredServices() {
            ...
            $.ajax({
                url: '/controllers/admin/services/sms/get-numbers',
                method: 'GET',
                data: {
                    country: country,
                    service: service,
                        ...
                        Object.entries(res.data).forEach(([countryCode, countryData]) => {
                            Object.entries(countryData).forEach(([serviceName, products]) => {
                                ...
                                Object.entries(products).forEach(([operator, productInfo]) => {
                                    ...
                                    let adminProfit = parseFloat(productInfo.admin_profit ?? 0).toLocaleString();
                                ...
                                <div class="card h-100 border-0 shadow-lg service-card"
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-12">
                                                <p class="text-muted mb-1" style="font-size: 12px;">Admin Profit</p>
                                                <h5 class="fw-bold mb-0 text-success">₦${adminProfit}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
