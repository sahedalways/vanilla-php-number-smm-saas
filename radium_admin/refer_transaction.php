...
$sql=mysqli_query($conn,"SELECT * FROM refer_history ORDER BY id DESC");
...
<head>
  <title>Refer Transfer- @getallscripts</title>
...
<script>
        $(document).ready(function() {
            ...
            $("#refer_transaction").addClass("active");
        });
    </script>
<body id="page-top">
  <div id="wrapper">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Refer Transaction</li>
            </ol>
          </div>
            ...
            <div class="col">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Refer Transaction</h6>
                </div>
