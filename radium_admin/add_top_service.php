                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Top Service</li>
                        </ol>
                    </div>
                            ...
                            <div class="card mb-4" id="loading">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="server_id" id="server_id" class="form-control mb-3">
                                            ...
                                            while ($row = mysqli_fetch_array($statement)) {
                                                ?>
                                                <option value="<?php echo $row['id']; ?>"><?php echo $row['server_name']; ?>
                                                </option>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <button type="submit" id="update"
                                        class="btn btn-primary w-100 mb-2">Submit</button><br>
                                </div>
