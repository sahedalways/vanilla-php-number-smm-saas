...
<head>
  <title>Add Custom Price - @getallscripts</title>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
           <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add Custom Price</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="card mb-4" id="loading">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Add Custom Price</h6>
                </div>
                <div class="card-body">
            ...
            $statement = mysqli_query($conn,$query);
                  ...
                  <select name="type" id="type" class="form-control mb-3">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Enter User Email</label>
                      <input type="email" class="form-control" id="user_email"  placeholder="Enter User Email">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Custom Value</label>
                      <input type="number" class="form-control" id="custom_value"  placeholder="Enter Custom Value">
                    </div>
