...
if($short_code !="" && $image_url !="" ){

$sql=mysqli_query($conn,"SELECT * FROM service_icon WHERE short_code='$short_code'");
if(mysqli_num_rows($sql) ==0){
    $sql3 = mysqli_query($conn,"INSERT INTO service_icon (short_code, img_url) VALUES ('$short_code','$image_url')");
