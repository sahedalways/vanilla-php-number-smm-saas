...
$sql=mysqli_query($conn,"SELECT * FROM top_services WHERE server_id='$server_id' AND service_id='$service_id'");
if(mysqli_num_rows($sql) ==0){
    $sql3 = mysqli_query($conn,"INSERT INTO top_services (server_id, service_id, status) VALUES ('$server_id','$service_id','1')");
