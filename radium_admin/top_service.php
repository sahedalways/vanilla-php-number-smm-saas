        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Top Service</li>
            </ol>
          </div>
            ...
            <div class="col">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a href="add_top_service"><button class="btn btn-sm btn-primary">Add Top Service</button></a>
                </div>
                <div class="table-responsive p-3">
                  ...
                  if (isset($_POST['delete'])) {
                    $unban = $_POST['id'];
                    $sql2 = mysqli_query($conn, "DELETE FROM `top_services` WHERE `id` ='" . $unban . "'");
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      while ($data = mysqli_fetch_array($sql)) {
                        $sql1 = mysqli_query($conn, "SELECT * FROM otp_server WHERE id='" . $data['server_id'] . "'");
                        if (mysqli_num_rows($sql1) == 1) {
                          $sql_data = mysqli_fetch_assoc($sql1);
                          $server = $sql_data['server_name'];
                        } else {
                          $server = '<p style="color:red">Deleted Server</p>';
                        }
                        ?>
                        <tr>
