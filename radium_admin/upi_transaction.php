...
$sql=mysqli_query($conn,"SELECT * FROM upi_recharge WHERE DATE(recharge_time) = '$today' and status='1' ORDER BY id DESC");
...
<head>
  <title>Upi Recharge - @getallscripts</title>
...
<script>
        $(document).ready(function() {
            ...
            $("#upi_transaction").addClass("active");
        });
    </script>
<body id="page-top">
  <div id="wrapper">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Upi Transaction</li>
            </ol>
          </div>
