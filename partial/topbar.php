...
<div style="border: 2px solid orange; border-radius: 20px; padding: 5px; ">
    ...
    <span class="font-bold text-sm" style="font-weight:bold; font-size:15px" id="current_balance">₦<?php echo $userwallet['balance']; ?></span>
</div>
                </li>
...
$img_url = 'https://allsmsverify.com/images/dpt1.png';
...
?>
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="media profile-media"><div class="avatar"><img class="img-40 rounded-circle" id="profile-imgs" src="<?php echo $img_url;?>" width="40" height="40" alt="#"></div>
