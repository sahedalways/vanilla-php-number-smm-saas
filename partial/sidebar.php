      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          ...
          <svg class="stroke-icon">
              ...
              <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="https://t.me/allsmsverifyteam" target="_blank">
          <svg class="stroke-icon">
          ...
          <svg class="stroke-icon">
              ...
              <svg class="fill-icon">
               ...
               <span>Telegram Channel</span></a>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="http://www.instagram.com/allsmsverify" target="_blank">
          <svg class="stroke-icon">
                <use href="assets/svg/icon-sprite.svg#stroke-button"></use>
              </svg>
              <svg class="fill-icon">
